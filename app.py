...
def get_text(event=None):
    ...
    if text is None:  # if the movie/tv show not found print some tips
        ...
        text_widget.insert(END, '\nYou can try the following:\n\n 1. Check for typos.\n '
                                '2. Check for NULL inputs.', 'tag-left')
...
helpMenu = Menu(menu, tearoff=0, font='Courier 11', bg='yellow',
                activebackground='black', activeforeground='white')
...
instructions_text.insert(END, "\n 1. Enter the keywords of a TV Show/Movie/Documentary. \n 2. Press ENTER or 'GET RECOMMENDATION!' to search. \n 3. Click on the Hyperlink to take you to the IMDb website.", 'tag-left')
# placing widgets
